...
class Ball:
    ...
    def updatePosition(self):
        ...
        self.x = newXY[0]
        self.y = newXY[1]
        canvas.create_circle(newXY[0], newXY[1], SIDE, fill=self.colour)
        ...
        if nextX < 0:
            ...
            if (self.angle > math.radians(90) ) and (self.angle < math.radians(180)):
                ...
                if randint(0,1) == 1:
                    self.angle = math.radians(randint(271,359))
                else:
                    self.angle = math.radians(randint(1,89))
            ...
            if (self.angle > math.radians(270) ) and (self.angle < math.radians(360)):
                ...
                self.angle = math.radians(randint(91,269))
            ...
            if (self.angle > math.radians(180) ) and (self.angle < math.radians(270)):
                ...
                self.angle = math.radians(randint(1,179))
            ...
            if (self.angle > math.radians(0) ) and (self.angle < math.radians(90)):
                ...
                self.angle = math.radians(randint(181,359))
